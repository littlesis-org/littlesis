...
class ScrapeForbes400Task extends sfBaseTask
{
  protected function configure()
  {
    ...
    $this->name             = 'forbes400';
    $this->briefDescription = 'Scrapes Forbes 400 profiles';
...
EOF;
  ...
  protected function execute($arguments = array(), $options = array())
  {
    ...
    $scraper = new Forbes400Scraper($options['test_mode'], $options['debug_mode'], $this->configuration);		

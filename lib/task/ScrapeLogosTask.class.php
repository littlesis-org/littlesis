...
class ScrapeLogosTask extends sfBaseTask
{
  protected function configure()
  {
    $this->namespace        = 'scraper';
    $this->name             = 'logos';
    $this->briefDescription = 'Scrapes logos';
...
EOF;
  ...
  protected function execute($arguments = array(), $options = array())
  {
    ...
    $scraper = new LogoScraper($options['test_mode'], $options['debug_mode'], $this->configuration);		
    $scraper->execute();
  }
}
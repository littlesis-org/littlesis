 ...
 */
class PluginOsEntityTransactionTable extends Doctrine_Table
{
  static function countByEntityId($id)
  {
    $db = Doctrine_Manager::connection();
    $sql = 'SELECT COUNT(*) FROM os_entity_transaction WHERE entity_id = ?';
  ...
  {
    $db = Doctrine_Manager::connection();    
    $sql = 'UPDATE os_entity_transaction SET locked_at = NULL, locked_by_user_id = NULL WHERE entity_id = ?';
    $stmt = $db->execute($sql, array($id));
  }
}
...
<?php if ($image) : ?>
	<?php echo link_to(image_tag(ImageTable::getPath($image, sfConfig::get('app_images_profile_type')), array('alt' => '')), EntityTable::getInternalUrl($entity, 'images')) ?>
  <?php slot('share_image', ImageTable::getPath($image, sfConfig::get('app_images_profile_type'))) ?>
<?php else : ?>

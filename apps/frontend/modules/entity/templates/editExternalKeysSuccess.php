...
<?php if (isset($existing_keys)) : ?>
  ...
  <form action="<?php echo url_for($entity->getInternalUrl('editExternalKeys',null,true)) ?>" method="POST">
...
<?php else : ?>
  ...
  <?php foreach($domains as $domain) : ?>
    <tr>
      ...
      <td class="form_field"><a href="<?php echo url_for($entity->getInternalUrl('editExternalKeys',array('domain_id' => $domain->id),false))?>">edit...</a></td>
      <td>

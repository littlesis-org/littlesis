...
<div class="help-article">Lists are people and organizations that belong on a page together because they share a common thread of power, but aren't part of a formal organization.
</div>
<br>
...
Editing a list allows you to change its name and description and indicate whether it’s ranked.  You can also <strong><a href="#adding-member">add</a></strong> and <strong><a href="#member-profile">remove</a></strong> list members and <strong><a href="#ranking-member">change their ranking</a></strong>.
<hr>
<ol class="num-list">
...
<a href="<?php echo image_path('system/help/member-profile.png') ?>"><img src="<?php echo image_path('system/help/member-profile.png') ?>" class="help-centered-image"></a>
...
<hr>
<a href="<?php echo image_path('system/help/analysis-list-interlocks.png') ?>"><img src="<?php echo image_path('system/help/analysis-list-interlocks.png') ?>" class="help-centered-image"></a>
...
<a href="<?php echo image_path('system/help/analysis-list-giving.png') ?>"><img src="<?php echo image_path('system/help/analysis-list-giving.png') ?>" class="help-centered-image"></a>
<p>The <strong>Giving</strong> tab shows the people and organizations that have received donations from members of the list, in order of amount donated. Advanced users can improve this tab by <strong><a href="/help/advancedLists#donations-member">matching list members with donation data from Open Secrets</a></strong>.</p>  
<a href="<?php echo image_path('system/help/analysis-list-funding.png') ?>"><img src="<?php echo image_path('system/help/analysis-list-funding.png') ?>" class="help-centered-image"></a>

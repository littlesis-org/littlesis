...
<hr>
<a href="<?php echo image_path('system/help/navigating-rel.png') ?>"><img src="<?php echo image_path('system/help/navigating-rel.png') ?>" class="help-centered-image"></a>
</div>
...
<br>When two people are part of the same family. <em>Examples</em> - children, spouses, cousins, siblings, etc.
...
<a href="<?php echo image_path('system/help/editing-rel.png') ?>"><img src="<?php echo image_path('system/help/editing-rel.png') ?>" class="help-centered-image"></a>
...
<td>Most relationships are important, but at least add the ones that link people or organizations already in the database.</td></tr></table></div>
</div>
<br>
<div class="help-top"><a href="#top">^back to top</a></div> 
...
<hr>
<div class="help-article"> 
Analysts can create relationships between 2 people (P+P), 2 organizations (O+O) or a person and an organization (P+O), but not all categories apply.  Only the categories that apply to the type of relationship you’re creating will be available to select.</div>
<br>
<div class="help-top"><a href="#top">^back to top</a></div> 
...
<a href="<?php echo image_path('system/help/q-lobbying.png') ?>"><img src="<?php echo image_path('system/help/q-lobbying.png') ?>" class="help-centered-image"></a>
<ul>
...
Check out our <strong><a href="/help/research/">research guide on LDA disclosure filings</a></strong> to learn more about how to research federal lobbying activity.</div>
<br>
<div class="help-top"><a href="#top">^back to top</a></div> 
...
<hr>
<div class="help-article"> 
<a href="<?php echo image_path('system/help/q-transactions.png') ?>"><img src="<?php echo image_path('system/help/q-transactions.png') ?>" class="help-centered-image"></a>
...
<hr>
<div class="help-article"> 
Advanced analysts can easily <strong><a href="/help/matchDonations#donations-person">find and add federal political donations</a></strong> made by people in LittleSis by matching their names to donors in OpenSecrets.  To check your level, click your username and click <strong>Settings</strong> on your dashboard header. 
</div>
<br>
<div class="help-top"><a href="#top">^back to top</a></div> 
...
<p>Because we collected most of the core data on the site using <strong><a href="/guide">automated processes</a></strong>, and because the site includes data on nearly 50,000 individuals and organizations—too much for us to verify by hand—there are some errors in the data.  Thanks for helping us sort them out!</p></div>
<div class="help-top"><a href="#top">^back to top</a></div> 

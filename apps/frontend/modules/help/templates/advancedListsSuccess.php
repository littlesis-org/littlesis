...
<div class="help-toc-article"><a href="/help/advancedLists#bulk-member">Adding List Members in Bulk</a> </div>
...
<li><strong><a href="/help/sources/">Reference the source</a></strong> of the list you are adding.
...
Browse existing <strong><a href="/lists">lists</a></strong> to get a better sense of what kinds of lists work in LittleSis.  If you’re working on a research project with other analysts, it might help to create a <strong><a href="/groups">research group </a></strong> where analysts can share findings and keep track of important lists, people, and organizations.  <strong><a href="/contact">Contact us</a></strong> to create a new research group. 
</div>
<br>
<div class="help-top"><a href="#top">^back to top</a></div> 
...
<li><strong><a href="/help/sources/">Reference the source</a></strong> of the list members you are adding. 
<li>Click <strong>Begin</strong> to look at the list of names found in your spreadsheet.
<a href="<?php echo image_path('system/help/bulk-member.png') ?>"><img src="<?php echo image_path('system/help/bulk-member.png') ?>" class="help-centered-image"></a>
...
<a href="<?php echo image_path('system/help/donations-member1.png') ?>"><img src="<?php echo image_path('system/help/donations-member1.png') ?>" class="help-centered-image"></a>
...
<a href="<?php echo image_path('system/help/donations-member2.png') ?>"><img src="<?php echo image_path('system/help/donations-member2.png') ?>" class="help-centered-image"></a>
...
Within a few minutes, your matches will update the list’s <strong><a href="help/beginnerLists#list-analysis">analysis tabs</a></strong> and generate new relationships between these people and their donation recipients, displayed on the profile pages of both entities.</div>
<br>
<div class="help-top"><a href="#top">^back to top</a></div> 

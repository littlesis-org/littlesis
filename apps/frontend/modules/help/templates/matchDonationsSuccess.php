...
<div class="help-toc-article"><a href="/help/advancedLists#donations-member">Matching a List’s Related Donors</a> </div>
<div class="help-toc-article"><a href="#q-donations-button">Why can't I click the Match Donations button on some profiles?</a> </div>
...
<br>
<br>
<a name="donations-person" class="help-anchor">text</a><div class="help-article-header">Matching a Person with Donor Records from OpenSecrets</div>
...
<td>You can also see which analyst last reviewed this donation data and when.  If the data has been updated in OpenSecrets since then, that date will appear highlighted in pink.</br> </td></tr></table></div>
...
Within a few minutes, your matches will update the person’s <strong><a href="/help/beginnerProfiles#profile-analysis">analysis tabs</a></strong> and generate new relationships between the person and their donation recipients, displayed on the profile pages of both entities.</div>
<br>
...
<div class="help-article">
<em>This tool is only available to advanced analysts.</em>
<p>Quickly match the people with positions in an organization to their donor records from OpenSecrets.<hr></p>
<ol class="help-num-list">
...
<a href="<?php echo image_path('system/help/donations-org1.png') ?>"><img src="<?php echo image_path('system/help/donations-org1.png') ?>" width="600" class="help-centered-image"></a>
<li>The person’s LittleSis profile summary are on the left hand side and a list of donor records from OpenSecrets with the same name are on the right hand side.
<br><div class="pointer_box"><table><tr><td><img width="60" src="http://s3.amazonaws.com/littlesis/images/system/finger.gif" alt="Finger"/></td>
<td>You can also see which analyst last reviewed this donation data and when.  If the data has been updated in OpenSecrets since then, that date will appear highlighted in pink.</br> </td></tr></table></div>
<li>Check all donor records that list the same employer as the person’s LittleSis profile.
<li>Scroll to the bottom of the page to see how many more people with positions in the org have possible matches. 
<a href="<?php echo image_path('system/help/donations-org2.png') ?>"><img src="<?php echo image_path('system/help/donations-org2.png') ?>" class="help-centered-image"></a>
...
Within a few minutes, your matches will update the organization’s <strong><a href="/help/beginnerProfiles#profile-analysis">analysis tabs</a></strong> and generate new relationships between these people and their donation recipients, displayed on the profile pages of both entities.</div>
<br>
<div class="help-top"><a href="#top">^back to top</a></div> 

<a name="q-donations-button" class="help-anchor">text</a><div class="help-article-header">Why can't I click the Match Donations button on some profiles?<hr></div>
<div class="help-article">If there are no donor records from OpenSecrets with similar names to the person in LittleSis, you won’t be able to click the Match Donations button.</div>
<br>
<div class="help-top"><a href="#top">^back to top</a></div> 

<a name="q-match-address" class="help-anchor">text</a><div class="help-article-header">What if a record’s employer doesn’t match or is blank, but the address is similar to another matching record?<hr></div>
<div class="help-article">
...
<br><div class="pointer_box"><table><tr><td><img width="60" src="http://s3.amazonaws.com/littlesis/images/system/finger.gif" alt="Finger"/></td>
<td>If the source links are broken, don’t check the record as a match and continue to the next record.</br></td></tr></table></div>
...
<a href="<?php echo image_path('system/help/q-match-address2.png') ?>"><img src="<?php echo image_path('system/help/q-match-address2.png') ?>" class="help-centered-image"></a>
<ol class="help-num-list">
...
<br><div class="pointer_box"><table><tr><td><img width="60" src="http://s3.amazonaws.com/littlesis/images/system/finger.gif" alt="Finger"/></td>
<td>If the source links are broken, don’t check the donation as a match.</br></td></tr></table></div>
...
You can also do a Google search in a new tab to verify if the person profiled in LittleSis has also worked for the other employer(s) listed.  If so,  <strong><a href="/help/beginnerRelationships#adding-rel">add a new relationship</a></strong> when you’re done matching donation data.</div>
<br>
<div class="help-top"><a href="#top">^back to top</a></div> 
...
<div class="help-article">
<hr>
The easiest way to do this is using your web browser’s <strong><a href="https://www.google.com/webhp?hl=en&tab=ww#fp=9a975e048e4bd6d6&hl=en&q=ctrl%2Bf">Find function (Ctrl+F)</a></strong> and entering one word from the name of the person’s current employer.</div>
<br>
<div class="help-top"><a href="#top">^back to top</a></div> 

...
<div class="help-toc-article"><a href="#bulk-processing-one">One entry at a time</a> </div>
...
<li><strong><a href="/help/sources">Reference the source</a></strong> of the new information you are about to add.
...
<div class="help-article">
<em>This tool is only available to advanced analysts.</em>
<p>Online articles and blog posts often contain lots of important information about powerful people and organizations and their relationships.  The LittleSis bookmarklet helps you easily add new people/orgs and relationships to LittleSis as you read about them in the news.  You can also use it just to search for people/orgs you read about to learn more.</p>  
<hr>
...
<a href="<?php echo image_path('system/help/bookmarklet.png') ?>"><img src="<?php echo image_path('system/help/bookmarklet.png') ?>" class="help-centered-image"></a>
...
<td>If you just want to add a new person/org to LittleSis--not add a relationship--click Refresh on your browser to exit the bookmarklet and continue reading.</br>  </td></tr></table></div>
...
<div class="help-article">
<em>This tool is only available to advanced analysts.</em>
<p>Ideal for adding a list of names and descriptive information from a website, email, document, etc.  If you have a list of names only, use the <strong><a href="#bulk-methods-text">Text Box method</a></strong>.</p>
<hr>
<ol class="help-num-list">
...
<div class="help-article">
<em>This tool is only available to advanced analysts.</em>
<p>Ideal for adding names (eg. board members, staff) directly from an organization’s website.  If the list is short, use the <strong><a href="#bulk-methods-text">Text Box method</a></strong> to manually copy and paste relevant names rather than rely on a bot.</p>
<hr>
<ol class="help-num-list">
...
<div class="help-article">
<em>This tool is only available to advanced analysts.</em>
<p>Ideal for adding a list of names from a website, email, document, etc.  If you have other descriptive information to include about the people/orgs on your list, use the <strong><a href="#bulk-methods-file">File method</a></strong>.</p>
<hr>
<ol class="help-num-list"> 
...
<div class="help-article">
<em>This tool is only available to advanced analysts.</em>
<p>Ideal for adding names found throughout a person’s LittleSis bio.  If the list is short, it’s often more effective to use the <strong><a href="#bulk-methods-text">Text Box method</a></strong> to manually copy and paste relevant names.</p>
<hr>
<ol class="help-num-list">
<li>Select what kind of entities you want the bot to look for on the page.
<li>Click <strong>Begin</strong> to continue.
...
<div class="help-article">
<em>This tool is only available to advanced analysts.</em>
<p>Ideal for finding people in LittleSis whose bios mention a particular organization and adding relationships between the two entities based on the description in the bio.</p>
<hr>
<ol class="help-num-list">
...
<a href="<?php echo image_path('system/help/bulk-methods.png') ?>"><img src="<?php echo image_path('system/help/bulk-methods.png') ?>" class="help-centered-image"></a>
<ul>
...
<div class="help-article">
<em>This tool is only available to advanced analysts.</em>
<p>Used to display and add each name from your list one-by-one.  Ideal for analysts new to the Add Bulk tool or without much time to finish the task.</p>
<hr>
<ol class="help-num-list">
...
<a href="<?php echo image_path('system/help/bulk-processing1.png') ?>"><img src="<?php echo image_path('system/help/bulk-processing1.png') ?>" class="help-centered-image"></a>
...
<br><div class="pointer_box"><table><tr><td><img width="60" src="http://s3.amazonaws.com/littlesis/images/system/finger.gif" alt="Finger"/></td>
<td>To skip a name--don’t add them to LittleSis or add a relationship--click <strong>Skip</strong> to continue to the next name</br></td></tr></table></div>
...
<div class="help-article">
<em>This tool is only available to advanced analysts.</em>
<p>Used to display and add every name from your list all on one page.  Ideal for analysts with lots of Add Bulk experience who have plenty of time to complete the task.</p>
<hr> 
<ol class="help-num-list">
...
<li>Click <strong>Begin</strong> or <strong>Continue</strong> to continue.
<a href="<?php echo image_path('system/help/bulk-processing2.png') ?>"><img src="<?php echo image_path('system/help/bulk-processing2.png') ?>" class="help-centered-image"></a>
...
<li>If no correct matches exist, click the circle next to <strong>Create new Person/Org</strong> and complete the form.  (eg. Sheila A Abdus-Salaam)</ul>
<br><div class="pointer_box"><table><tr><td><img width="60" src="http://s3.amazonaws.com/littlesis/images/system/finger.gif" alt="Finger"/></td>
<td>To skip a name--don’t add them to LittleSis or add a relationship--click the circle under <strong>No Action</strong>.</br></td></tr></table></div>

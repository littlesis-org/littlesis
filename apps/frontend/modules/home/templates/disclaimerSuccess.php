<?php slot('header_text', 'Disclaimer') ?>
...
<?php slot('pointer') ?>
If you have any questions about the content of this disclaimer, please <?php echo link_to('contact the LittleSis team', '@contact') ?>.
<?php end_slot() ?>

<?php include_partial('global/pointer', array('text' => get_slot('pointer'))) ?>

<span class="text_big">
LittleSis is an online open-content collaborative project, that is, a voluntary association of individuals and groups who are developing a common resource of human knowledge. The structure of the project allows anyone with an Internet connection and World Wide Web browser to sign up for an account and alter its content. While for the time being we are giving editing powers to trusted invdividuals only, please be advised that nothing found here has necessarily been reviewed by professionals with the expertise required to provide you with complete, accurate or reliable information.
<br />
<br />
That is not to say that you will not find valuable and accurate information in LittleSis; you usually will. However, LittleSis cannot guarantee the validity of the information found here. The content of any given page may recently have been changed, vandalized or altered by someone armed with inaccurate information.
<br />
<br />
</span>
...
<span class="text_big">
<a href="#noreview">No formal peer review</a><br />
...
<span class="text_big">
The LittleSis team is constantly keeping an eye on the data pulled in from our bots as well as the work of our analysts. Analysts themselves are encouraged to keep an eye out for mistakes made by other users. That's how a wiki works. However, LittleSis is not uniformly peer reviewed; while users may correct errors or engage in casual review, they have no legal duty to do so and thus all information read here is without any implied warranty of fitness for any purpose or use whatsoever.
<br />
<br />

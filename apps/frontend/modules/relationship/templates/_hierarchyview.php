...
<?php else : ?>
  <?php echo entity_link($relationship['Entity1']) ?> and <?php echo entity_link($relationship['Entity2']) ?> <?php echo (($current === NULL) ? "have/had" : ($current == '1' ? "have" : "had")) ?> a hierarchy relationship
<?php endif; ?>

...
<?php slot('header_text', 'Edit Ownership') ?>
...
<table>
  ...
  <tr>
    <td class="form_label">Owner</td>
    <td id="entity1_field" class="form_field text_big"><?php echo entity_link($entity1) ?></td>
  </tr>

<?php if (($entity2->primary_ext != 'Person') && ($entity2->primary_ext != 'Person')) : ?>
  <tr>
    <td></td>
    <td class="form_field">
...
<?php endif; ?>
  ...
  <tr>
    ...
    <td class="form_field">
      <?php echo $category_form['description1']->render() ?> or
      <?php echo $category_form['description_new']->render() ?>
    </td>  
  </tr>

  <?php include_partial('global/form', array(
    'form' => $category_form,
    'field_names' => array('start_date', 'end_date', 'is_current', 'percent_stake', 'shares', 'notes')
  )) ?>

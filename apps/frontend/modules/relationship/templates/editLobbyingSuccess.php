...
<?php slot('header_text', 'Edit Lobbying') ?>
...
<table>
  ...
  <tr>
    <td class="form_label">Lobbyist/Firm</td>
  ...
  <tr>
    <td class="form_label">Politician/Agency</td>
  ...
  <?php include_partial('global/form', array(
    'form' => $category_form,
    'field_names' => array('start_date', 'end_date', 'is_current', 'amount', 'notes')
  )) ?>

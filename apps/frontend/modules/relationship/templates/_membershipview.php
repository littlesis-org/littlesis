...
<span class="text_big">
<?php slot('share_text') ?>
<?php echo entity_link($relationship['Entity1']) ?> <?php echo (($current === NULL) ? "is/was" : ($current == '1' ? "is" : "was")) ?> a member of <?php echo entity_link($relationship['Entity2']) ?>
<?php end_slot() ?>
...
<?php $data = array(
  ...
  'Dues' => readable_number($relationship['dues'], '$'),

...
<span class="text_big">
<?php slot('share_text') ?>
<?php echo entity_link($relationship['Entity1']) ?> <?php echo (($current === NULL) ? "is/was" : ($current == '1' ? "is" : "was")) ?> a student of <?php echo entity_link($relationship['Entity2']) ?>
<?php end_slot() ?>
...
<?php $data = array(
  ...
  'Degree' => RelationshipTable::getDegreeNameById($relationship['id']),
  'Field' => $relationship['field'],
  'Is dropout' => LsLogic::nullOrBoolean($relationship['is_dropout']),
